    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link href="/" className="flex justify-center">
          <span className="text-3xl font-bold text-green-600">Cari Kerja</span>
        </Link>
          ...
          <form className="space-y-6" action="#" method="POST">
            <div>
              ...
              <div className="mt-1">
                ...
                >
                  <option value="buyer">Client - Saya nak cari freelancer</option>
                  <option value="seller">Freelancer - Saya nak tawarkan perkhidmatan</option>
                </select>
              </div>
            </div>
